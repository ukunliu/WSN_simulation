...
function NYUSIM_v31_MAC
%% Clear variables and set runningFolder as the current path
...
txt = uicontrol('Style','text','Position',[32 515 250 15],'String','2. Set your input parameters below',...
    'FontSize',FS,'FontWeight','bold','BackgroundColor',bgColor2);
txt = uicontrol('Style','text','Position',[33 500 220 15],'String','3. Select a folder to save files',...
    'FontSize',FS,'FontWeight','bold','BackgroundColor',bgColor2);
txt = uicontrol('Style','text','Position',[56 485 90 15],'String','4. Click Run',...
    'FontSize',FS,'FontWeight','bold','BackgroundColor',bgColor2);
txt = uicontrol('Style','text','Position',[55 470 340 15],'String','5. To run another simulation, click Reset, and repeat Steps 2-4',...
    'FontSize',FS,'FontWeight','bold','BackgroundColor',bgColor2);
...
[mtree, container] = uitree('v0', 'Root','/Users/');
