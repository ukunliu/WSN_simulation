...
# parameter grids
lgb_grid = {
    'lgb__estimator__n_estimators': [200, 500, 1000, 2000, 2500],
    'lgb__estimator__max_depth': [500, 1000, 2500, 3000, 4000]
    }

lgb_grid_rssi = {
    'lgb__estimator__n_estimators': [100, 200, 400],
    'lgb__estimator__max_depth': [100, 200, 400, 500]
    }
